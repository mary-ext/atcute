...
await build({
	'linux-x64-glibc': {
		...
		output: 'prebuilds/linux-x64-glibc/time-ms.node',
		glibc: '2.17',
	},
	'linux-x64-musl': {
		...shared,
		target: 'x86_64-linux-musl',
		output: 'prebuilds/linux-x64-musl/time-ms.node',
	},
	'linux-arm64-glibc': {
		...shared,
		target: 'aarch64-linux-gnu',
		output: 'prebuilds/linux-arm64-glibc/time-ms.node',
		glibc: '2.17',
	},
	'linux-arm64-musl': {
		...shared,
		target: 'aarch64-linux-musl',
		output: 'prebuilds/linux-arm64-musl/time-ms.node',
	},
	'darwin-arm64': {
		...shared,
		target: 'aarch64-macos',
		output: 'prebuilds/darwin-arm64/time-ms.node',
		// NAPI symbols are resolved at load time by the Node.js runtime
