...
await build({
	'linux-x64-glibc': {
		...
		output: 'prebuilds/linux-x64-glibc/grapheme.node',
		glibc: '2.17',
	},
	'linux-x64-musl': {
		...shared,
		target: 'x86_64-linux-musl',
		output: 'prebuilds/linux-x64-musl/grapheme.node',
	},
	'linux-arm64-glibc': {
		...shared,
		target: 'aarch64-linux-gnu',
		output: 'prebuilds/linux-arm64-glibc/grapheme.node',
		glibc: '2.17',
	},
	'linux-arm64-musl': {
		...shared,
		target: 'aarch64-linux-musl',
		output: 'prebuilds/linux-arm64-musl/grapheme.node',
	},
	'darwin-arm64': {
		...shared,
		target: 'aarch64-macos',
		output: 'prebuilds/darwin-arm64/grapheme.node',
		cflags: [...shared.cflags, '-Wl,-undefined,dynamic_lookup'],
	},
	'win32-x64': {
		...shared,
		target: 'x86_64-windows',
		output: 'prebuilds/win32-x64/grapheme.node',
		libraries: ['node'],
