...
const _mainSchema = /*#__PURE__*/ v.record(
	...
	/*#__PURE__*/ v.object({
		$type: /*#__PURE__*/ v.literal('community.lexicon.app.entry'),
		/**
		...
		/**
		 * Human language of this entry's text. This describes the listing, not the languages supported by the
		 * app.
		 *
		 * @maxLength 3
		 */
		...
		profileDid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.didString()),
		/** Current release or maintenance status of the app. */
		get status() {
			return /*#__PURE__*/ v.optional(CommunityLexiconAppDefs.statusSchema);
		},
		/**
		 * Open discovery tags for filtering and search, preferably lowercase. Do not use tags for platforms,
		 * lexicon interoperability, or listing language.
		 *
		 * @maxLength 10
		 */
...
declare module '@atcute/lexicons/ambient' {
	interface Records {
		'community.lexicon.app.entry': mainSchema;
	}
}
