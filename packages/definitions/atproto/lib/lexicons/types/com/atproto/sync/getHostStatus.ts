...
import * as ComAtprotoSyncDefs from './defs.ts';
...
const _mainSchema = /*#__PURE__*/ v.query('com.atproto.sync.getHostStatus', {
	...
	output: {
		...
		schema: /*#__PURE__*/ v.object({
			/**
			 * Number of accounts on the server which are associated with the upstream host. Note that the upstream
			 * may actually have more accounts.
			 */
