...
const _labelValueDefinitionSchema = /*#__PURE__*/ v.object({
	...
	/**
	 * What should this label hide in the UI, if applied? 'content' hides all of the target; 'media' hides the
	...
	/**
	 * How should a client visually convey this label? 'inform' means neutral and informational; 'alert' means
	 * negative and warning; 'none' means show nothing.
	 */
