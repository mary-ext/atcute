...
const _mainSchema = /*#__PURE__*/ v.query('sh.tangled.repo.getIssues', {
	params: /*#__PURE__*/ v.object({
		 ...
		 * @maxLength 50
		 */
		issues: /*#__PURE__*/ v.constrain(/*#__PURE__*/ v.array(/*#__PURE__*/ v.resourceUriString()), [
...
const _recordViewSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('sh.tangled.repo.getIssues#recordView')),
