...
import * as ShTangledRepoListIssues from './listIssues.ts';

const _mainSchema = /*#__PURE__*/ v.query('sh.tangled.repo.listIssuesBy', {
	...
	output: {
		...
		schema: /*#__PURE__*/ v.object({
			cursor: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string()),
			get items() {
				return /*#__PURE__*/ v.array(ShTangledRepoListIssues.issueListItemSchema);
			},
		}),
	},
});
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'sh.tangled.repo.listIssuesBy': mainSchema;
	}
}
