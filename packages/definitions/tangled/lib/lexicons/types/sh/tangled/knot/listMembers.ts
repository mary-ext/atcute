...
const _listItemSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('sh.tangled.knot.listMembers#listItem')),
...
const _mainSchema = /*#__PURE__*/ v.query('sh.tangled.knot.listMembers', {
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'sh.tangled.knot.listMembers': mainSchema;
	}
}
