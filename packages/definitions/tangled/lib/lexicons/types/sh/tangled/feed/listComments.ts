...
const _listItemSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('sh.tangled.feed.listComments#listItem')),
	cid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.cidString()),
	uri: /*#__PURE__*/ v.resourceUriString(),
	/** Embedded sh.tangled.feed.comment record */
	value: /*#__PURE__*/ v.unknown(),
});
const _mainSchema = /*#__PURE__*/ v.query('sh.tangled.feed.listComments', {
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'sh.tangled.feed.listComments': mainSchema;
	}
}
