...
const _listItemSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('sh.tangled.pipeline.listPipelines#listItem')),
	cid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.cidString()),
	uri: /*#__PURE__*/ v.resourceUriString(),
	/** Embedded sh.tangled.pipeline record */
	value: /*#__PURE__*/ v.unknown(),
});
const _mainSchema = /*#__PURE__*/ v.query('sh.tangled.pipeline.listPipelines', {
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'sh.tangled.pipeline.listPipelines': mainSchema;
	}
}
